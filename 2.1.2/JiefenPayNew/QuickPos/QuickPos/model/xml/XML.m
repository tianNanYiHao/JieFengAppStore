...
//    NSString *strVersion = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"] ;
    ...
    // sign
    DDXMLNode *nSign = [DDXMLNode elementWithName:@"sign" stringValue:SIGN];
    [root addChild:nSign];
