...
@property (weak, nonatomic) IBOutlet UILabel *amtTitleLabel;
...
//    [self titleLabelAndInstructions];
    
//    self.amtTitleLabel.text = [NSString stringWithFormat:@"%d%@",[self.AmtNO intValue]/100,@"￥"];
    
    self.amtTitleLabel.text = [NSString stringWithFormat:@"%.2f%@",self.AmtNO.doubleValue/100,@"￥"];
    
//    http://122.144.198.81:8081/easypay/phone/alipay?orderId=test&orderAmt=1
    
    NSString *url1 = @"http://122.144.198.81:8081/easypay/phone/alipay?orderId=";
    NSString *url2 = @"&orderAmt=";
    
    self.urlString = [NSString stringWithFormat:@"%@%@%@%@",url1,self.orderId,url2,self.AmtNO];
