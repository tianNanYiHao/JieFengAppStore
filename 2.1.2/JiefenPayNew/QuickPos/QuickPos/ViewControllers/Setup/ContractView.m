...
- (instancetype)init{
    ...
    if (self) {
        ...
        self.telephone.text = [NSString stringWithFormat:@"400-008-1655",L(@"ContactCompany"),[[delegate getConfigDic] objectForKey:@"customerService"]];
        NSString *url;
        if ([[[delegate getConfigDic] objectForKey:@"website"]hasPrefix:@"http://www.jiefengpay.com"]) {
            url = [NSString stringWithFormat:@"http://www.jiefengpay.com",L(@"CompanyWebsite"),[[delegate getConfigDic] objectForKey:@"website"]];
        }else{
            url = [NSString stringWithFormat:@"http://www.jiefengpay.com",L(@"CompanyWebsite"),[[delegate getConfigDic] objectForKey:@"website"]];
        }
...
//    NSString *telUrl = [NSString stringWithFormat:@"tel://%@",[[delegate getConfigDic] objectForKey:@"customerService"]];
    ...
    NSString *telUrl = [NSString stringWithFormat:@"tel://%@",@"4000081655"];
